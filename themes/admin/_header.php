              ...
              <ul class="nav ace-nav pull-right">
                    ...
                    <li class="green">
                        ...
                        <ul class="pull-right dropdown-navbar dropdown-menu dropdown-caret dropdown-closer">
                            ...
                            <li>
                                <a href="#">
                                    <img alt="Alex's Avatar" class="msg-photo" src="themes/admin/media/images/avatar.png" />
                                    <span class="msg-body">
                            ...
                            <li>
                                <a href="#">
                                    <img alt="Susan's Avatar" class="msg-photo" src="themes/admin/media/images/avatar3.png" />
                                    <span class="msg-body">
                                        <span class="msg-title">
                            ...
                            <li>
                                <a href="#">
                                    <img alt="Bob's Avatar" class="msg-photo" src="themes/admin/media/images/avatar4.png" />
                                    <span class="msg-body">
                                        <span class="msg-title">
