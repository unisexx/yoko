            ...
            <div id="main-content" class="clearfix">
                    ...
                    <div id="page-content" class="clearfix">
                        ...
                        <div class="page-header position-relative">
                            <h1>Widgets <small><i class="icon-double-angle-right"></i> Widget Boxes & Containers</small></h1>
                        </div><!--/page-header-->
              ...
              <table id="table_bug_report" class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="hidden-480"><span class="label label-inverse arrowed">Blocked</span></td>
                    </tr>
    ...
    <div class="span6">
        <div class="widget-box collapsed">
            <div class="widget-header widget-header-small header-color-orange">
                <h6><i class="icon-sort"></i> Small Header & Collapsed</h6>
                <div class="widget-toolbar">
                    <a href="#" data-action="settings"><i class="icon-cog"></i></a>
                    <a href="#" data-action="reload"><i class="icon-refresh"></i></a>
                    <a href="#" data-action="collapse"><i class="icon-chevron-up"></i></a>
        ...
        <div class="widget-box">
            <div class="widget-header widget-header-small header-color-dark">
                ...
                <div class="widget-toolbar no-border">
                    <label>
                        <input type="checkbox" class="ace-switch ace-switch-3" /><span class="lbl"></span>
                    </label>
                </div>
                <div class="widget-toolbar">
    ...
    <div class="span6">
        <div class="widget-box">
            <div class="widget-header header-color-dark">
                ...
                <div class="widget-toolbar">
                    <div class="progress progress-mini progress-danger progress-striped active" style="width:100px;" data-percent="61%"><div class="bar" style="width:61%"></div></div>
                </div>
            </div>
            ...
            <div class="widget-body">
                <div class="widget-toolbox">
                    <div class="btn-toolbar">
                        <div class="btn-group">
                            <button class="btn btn-small btn-success"><i class="icon-ok"></i> Approve</button>
                            <button class="btn btn-small btn-danger"><i class="icon-remove"></i> Reject</button>
                        </div>
                        <div data-action="buttons-checkbox" class="btn-group">
                        ...
                        <div data-action="buttons-radio" class="btn-group">
                            <button class="btn btn-small btn-primary"><i class="icon-only icon-align-left"></i></button>
                            <button class="btn btn-small btn-primary"><i class="icon-only icon-align-center"></i></button>
                            <button class="btn btn-small btn-primary"><i class="icon-only icon-align-right"></i></button>
                        </div>
                        <div class="btn-group">
                            <button data-toggle="dropdown" class="btn btn-small btn-grey dropdown-toggle"><i class="icon-caret-down icon-only"></i></button>
    ...
    <div class="span6">
        <div class="widget-box">
            <div class="widget-header header-color-pink">
                ...
                <div class="widget-toolbar">
                    <a href="#" data-action="collapse"><i class="1 icon-chevron-up icon-2x"></i></a>
                </div>
                <div class="widget-toolbar no-border">
                    <button class="btn btn-mini btn-light bigger"><i class="icon-arrow-left"></i> Prev</button>
                    <button class="btn btn-mini bigger btn-yellow dropdown-toggle" data-toggle="dropdown">Next <i class="icon-angle-down icon-on-right"></i></button>
            ...
            <div class="widget-body">
                ...
                <div class="widget-toolbox padding-8 clearfix">
                    <button class="btn btn-mini btn-danger pull-left"><i class="icon-remove"></i> I don't accept</button>
                    <button class="btn btn-mini btn-success pull-right">I accept <i class="icon-arrow-right icon-on-right"></i></button>
                </div>
            </div>
