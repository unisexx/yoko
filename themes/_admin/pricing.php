            ...
            <div id="sidebar">
                ...
                <ul class="nav nav-list">
                    ...
                    <li class="active open">
                      ...
                      <ul class="submenu">
                        <li class="active"><a href="pricing.php"><i class="icon-double-angle-right"></i> Pricing Tables</a></li>
            ...
            <div id="main-content" class="clearfix">
                    ...
                    <div id="page-content" class="clearfix">
                        ...
                        <div class="page-header position-relative">
                            <h1>Pricing Tables <small><i class="icon-double-angle-right"></i> Large & Small</small></h1>
                        </div><!--/page-header-->
    ...
    <div class="span3">
        <div class="widget-box pricing-box">
            ...
            <div class="widget-body">
                ...
                <div>
                    <a href="#" class="btn btn-block btn-inverse"><span>Buy</span></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="span3">
        <div class="widget-box pricing-box">
            ...
            <div class="widget-body">
                ...
                <div>
                    <a href="#" class="btn btn-block btn-warning"><span>Buy</span></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="span3">
        <div class="widget-box pricing-box">
            ...
            <div class="widget-body">
                ...
                <div>
                    <a href="#" class="btn btn-block btn-primary"><span>Buy</span></a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="widget-body">
                <div class="widget-main">
                    <ul class="unstyled spaced2">
                        ...
                        <li><i class="icon-ok green"></i> Unlimited Bandwidth </li>
                        <li><i class="icon-ok green"></i> Unlimited Email Accounts </li>
                        <li><i class="icon-ok green"></i> Unlimited MySQL Databases </li>
                ...
                <div>
                    <a href="#" class="btn btn-block btn-success"><span>Buy</span></a>
                </div>
            </div>
        </div>
    </div>
...
<div class="row-fluid">
        ...
        <div class="widget-box pricing-box-small">
            ...
            <div class="widget-body">
             <div class="widget-main no-padding">
                ...
                <div class="price">
                    <span class="label label-large label-inverse arrowed-in arrowed-in-right">$5<small>/month</small></span>
                </div>
             </div>
             <div>
                <a href="#" class="btn btn-block btn-small btn-danger"><span>Buy</span></a>
             </div>
            </div>
        </div>
    </div>
        ...
        <div class="widget-box pricing-box-small">
            ...
            <div class="widget-body">
             <div class="widget-main no-padding">
                ...
                <div class="price">
                    <div class="label label-large label-inverse arrowed-in arrowed-in-right">$10<small>/month</small></div>
                </div>
             </div>
             <div>
                <a href="#" class="btn btn-block btn-small btn-warning"><span>Buy</span></a>
             </div>
            </div>
        </div>
    </div>
        ...
        <div class="widget-box pricing-box-small">
            ...
            <div class="widget-body">
             <div class="widget-main no-padding">
                ...
                <div class="price">
                    <div class="label label-large label-inverse arrowed-in arrowed-in-right">$15<small>/month</small></div>
                </div>
             </div>
             <div>
                <a href="#" class="btn btn-block btn-small btn-primary"><span>Buy</span></a>
             </div>
            </div>
        </div>
    </div>
    ...
    <div class="span2 pricing-span">
        <div class="widget-box pricing-box-small">
            <div class="widget-header header-color-green">
                <h5 class="bigger lighter">Ultimate</h5>
            </div>
            <div class="widget-body">
             <div class="widget-main no-padding">
                <ul class="unstyled list-striped  pricing-table">
                ...
                <div class="price">
                    <div class="label label-large label-inverse arrowed-in arrowed-in-right">$25<small>/month</small></div>
                </div>
             </div>
             <div>
                <a href="#" class="btn btn-block btn-small btn-success"><span>Buy</span></a>
             </div>
            </div>
        </div>
    </div>
    ...
    <div class="span2 pricing-span">
        <div class="widget-box pricing-box-small">
            ...
            <div class="widget-body">
             ...
             <div>
                <a href="#" class="btn btn-block btn-small btn-grey"><span>Buy</span></a>
             </div>
            </div>
        </div>
    </div>
