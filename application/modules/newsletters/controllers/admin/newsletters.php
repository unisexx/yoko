		...
		if($_POST)
		{
			...
			if($_POST['sendmail'] == 1){
				...
				// ###### PHPMailer #### 
					...
					$mail->Port = 465;
					$mail->Username = 'mso.tpso1@gmail.com';
					$mail->Password = 'mso.tpso1';
					$mail->SMTPAuth = true;
					$mail->CharSet = "utf-8";
					$mail->From = "tpso1@hotmail.com";		//  account e-mail ของเราที่ใช้ในการส่งอีเมล
					$mail->FromName = "สำนักงานส่งเสริมและสนับสนุนวิชาการ ๑";
